...
class SubgroupEditorDialog(simpledialog.Dialog):
    def __init__(self, parent, title=None, group_id=None, initial_name="", initial_template_id=None):
        ...
        self.templates_map = {"(No Template)": None}
        super().__init__(parent, title)

    def body(self, master):
        ttk.Label(master, text="Subgroup Name:").grid(row=0, column=0, sticky="w", padx=5, pady=5)
        ...
        ttk.Label(master, text="Indicator Template:").grid(row=1, column=0, sticky="w", padx=5, pady=5)
